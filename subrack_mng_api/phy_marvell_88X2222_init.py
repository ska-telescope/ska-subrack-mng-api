...
def wr(address,value):
	...
	tpm_inst[address] = value

def rd(address):
	value=None
	value = tpm_inst[address]
...
def read_and_decode(port,reg_def):
...
def get_port_cfg(port):
	...
	read_and_decode(port,phy_control_reg)
	read_and_decode(port,port_control_reg)
...
def set_SFP():
	...
	write22(2,9,0x0,0x9)
	#/* P9
	write22(2,0x1c,25,0xF054)
	write22(2,0x1c,24,0x8124)
	write22(2,0x1c,25,0x400c)
	write22(2,0x1c,24,0x8524)
	write22(2,0x1c,25,0xF054)
	write22(2,0x1c,24,0x8124)
	write22(2,0x1c,25,0x4000)
	write22(2,0x1c,24,0x8524)
	#/*Start configuring ports for traffic
	#/*Clear power down bit and reset SERDES P9
	write22(2,0x1c,25,0x2000)
	write22(2,0x1c,24,0x8124)
	write22(2,0x1c,25,0xa040)
	write22(2,0x1c,24,0x8524)
	#/*Fix 1000Base-X AN advertisement
	#/*write45 4.2004.5 to 1
	#/* ADDR 0x09
	write22(2,0x1c,25,0x2004)
	write22(2,0x1c,24,0x8124)
	write22(2,0x1c,25,0x20)
	write22(2,0x1c,24,0x8524)
	#/*Enable Forwarding on ports:
	write22(2,9,4,0x007F)
	get_port_cfg(9)
