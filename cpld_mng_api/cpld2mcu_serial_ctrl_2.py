...
parser.add_option("-s", "--send",
                dest="send", default="",
                help="send a character or string to MCU")
parser.add_option("-r", "--receive",
                action="store_true",dest="receive", default=False,
                help="receive data from MCU")
parser.add_option("-b", "--setgpnvm",
                action="store_true",dest="setgpnvm", default=False,
                help="send Flash GPNVM set command")
parser.add_option("-c", "--clrgpnvm",
                action="store_true",dest="clrgpnvm", default=False,
...
parser.add_option("-w", "--write",
                dest="write", default="",
                help="Write a word to MCU Flash ")
