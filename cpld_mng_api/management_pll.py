...
usage_hexample="es.(load configuration) %prog -l -f our_pll_cfg.txt \nes.(dump configuration) %prog -d -f dump_pll_cfg.txt\n" \
...
if __name__ == "__main__":
    ...
    parser.add_option("-l","--ldcfg",
                    action="store_true",
                    dest="pll_ldcfg",
                    default=False,
                    help="Require Load PLL cfg from file")
    parser.add_option("-d","--dumpcfg",
                    action="store_true",
                    dest="pll_dumpcfg",
                    default=False,
